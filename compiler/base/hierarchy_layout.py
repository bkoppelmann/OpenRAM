...
class layout():
    ...
    def add_via_stack(self, offset, direction, from_layer, to_layer,
        ...
        return self.__add_via_stack_internal(offset, direction, from_layer,
                                             to_layer, self.add_via, size)
    ...
    def copy_power_pins(self, inst, name):
        ...
        for pin in pins:
            if pin.layer==self.pwr_grid_layer:
                ...
                debug.warning("{0} pins of {1} should be on '{2}' or 'm1' "\
                              "for supply router."
